...
(defn explode-str [str sep]
  ...
  ;(map #(seq (str/split % #"")) (str/split str sep))
  (str/split (str/trim str) sep)
)
...
(assert-eq-msg 24000 (solve-day01-a teststr) "pt 1 test result")
